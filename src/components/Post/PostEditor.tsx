...
const PostEditor = () => {
  ...
  const onSubmit = (data: FormData) => {
    ...
    axios
      .post('http://127.0.0.1:3000/api/post', newPost, {
        headers: {
            ...
            <div className="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <div className="p-6 text-center">
                ...
                <h3 className="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">
                  Êtes-vous sûr de vouloir valider ce post ?
                </h3>
                <button
                  data-modal-hide="popup-modal"
                  type="submit"
                  className="text-white bg-gray-600 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center mr-2"
                >
                  oui
                </button>
                <button
