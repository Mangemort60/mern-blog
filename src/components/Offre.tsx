const Offre = () => {
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:w-4/6 m-4 md:mx-auto mt-8 h-auto md:h-[400px]">
      <div className="bg-[#2babc8] text-white border shadow-sm rounded-sm p-6  flex flex-col justify-between ">
      ...
      <div className="bg-[#e5bce1] border shadow-sm rounded-sm p-6  flex flex-col justify-between">
      ...
      <div className="bg-[#e8e9c9] border shadow-sm rounded-sm p-6 pb-2  flex flex-col justify-between">
      ...
      <div className="bg-[#edede0] border shadow-sm rounded-sm p-6 pb-2  flex flex-col justify-between">
